...
and its part of so many projects, they just have to learn a bit about it.
...
In this section we have set up something that makes projects esier to manage.
...
somehting we can worry about later for this example.  
