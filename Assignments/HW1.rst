...
that will contain all homework you do for this course.

Here is the link you need to start this project:

..  WARNING::

    Be sure to choose the right link here:
...
All you need to do for this test is add a ``README.rst`` file to the repository
with a simple message of some kind. Follow the steps we discussed in class to
add the changes to your working copy, commit them, then push ten back up to the
GitHub_ server. Again, thr notes in the Appendix cover this process.
